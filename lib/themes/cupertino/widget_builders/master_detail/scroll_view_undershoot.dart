...
class ScrollViewUndershoot extends StatefulWidget {
  ...
  const ScrollViewUndershoot.builder({
    super.key,
    this.scrollDirection = Axis.vertical,
    this.startUndershoot = true,
    this.endUndershoot = true,
  ...
  @override
  State<ScrollViewUndershoot> createState() => _ScrollViewUndershootState();
}

class _ScrollViewUndershootState extends State<ScrollViewUndershoot> {
  ...
  Widget build(BuildContext context) {
    final light = CupertinoTheme.of(context).brightness == Brightness.light;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                CupertinoColors.black.withOpacity(light ? 0.1 : 0.3),
                CupertinoColors.black.withOpacity(0.0) /*.transparent*/,
              ],
            ),
          ),
        ),
