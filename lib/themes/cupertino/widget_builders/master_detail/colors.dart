...
class MasterDetailColors {
  const MasterDetailColors._({
    required this.error,
  ...
  factory MasterDetailColors.from(Brightness brightness) {
    return switch (brightness) {
      Brightness.light => MasterDetailColors.light,
      Brightness.dark => MasterDetailColors.dark,
    };
  }

  /// Colors for the given [context].
  static MasterDetailColors of(BuildContext context) {
    return MasterDetailColors.from(CupertinoTheme.brightnessOf(context));
  }

  /// Theme-specific colors for light themes.
  static const light = MasterDetailColors._(
  ...
  static const dark = MasterDetailColors._(
...
extension MasterDetailColorExtension on Color {
